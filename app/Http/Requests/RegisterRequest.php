...
class RegisterRequest extends BaseRequest
{
    public function rules()
    {
        return [
            ...
            'province' => 'required|string|in:province-1,province-2,bagmati,gandaki,lumbini,karnali,sudurpashchim',
    ...
    public function messages()
    {
        return [
            ...
            'province.in' => 'Province cannot be other than the 7 provinces of Nepal',
            'district.required' => 'District must be selected',
