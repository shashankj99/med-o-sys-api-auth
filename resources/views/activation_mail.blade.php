...
<head>
    ...
    <style type="text/css">
        ...
        @media only screen {
            ...
            .serif {
                font-family: "Montserrat", -apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", "Roboto", Helvetica, Arial, sans-serif;
            }
...
<table class="wrapper" align="center" bgcolor="#EEEEEE" cellpadding="0" cellspacing="0" width="100%"
    ...
    <tr>
        <td style="padding: 30px 0;">
            ...
            <!-- Header Centered -->
            <table class="row" align="center" bgcolor="#043b86" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                    <td class="spacer" height="20" style="line-height: 30px;">&nbsp;</td>
                </tr>
                <tr>
            ...
            <table class="row" align="center" bgcolor="#043b86" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                    <th class="column" width="640" style="padding-left: 30px; padding-right: 30px; color: #ffffff;">
                        <div class="spacer" style="line-height: 70px;">&nbsp;</div>
                        <div class="serif h1" style="font-size: 45px; line-height: 50px; margin-bottom: 25px;">Welcome
                            to<br>Med-O-Sys
                        </div>
            ...
            <table class="row" align="center" bgcolor="#F8F8F8" cellpadding="0" cellspacing="0" role="presentation">
                ...
                <tr>
                    <th class="column" width="640"
                        ...
                        <div class="serif"
                             style="color: #1F2225; font-size: 28px; font-weight: 700; line-height: 50px; margin-bottom: 30px;">
                        ...
                        <table class="mobile-text-center" bgcolor="#043b86" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <th class="sans-serif">
                                    <a href="{{ env('APP_URL') . '/activate/' . $user->verificationToken->token }}"
                        ...
                        <table class="row" cellpadding="0" cellspacing="0" role="presentation">
                            <tr valign="top" style="vertical-align: top;">
                                <th class="column mobile-padding-bottom" width="255"
                                    style="padding-top: 10px; padding-right: 10px; text-align: left;">
                                    <a href="#">
                                        <img src="#"
                                             alt="Footer Logo" width="300">
                                    </a>
                                </th>
